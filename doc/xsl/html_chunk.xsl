...
<!-- Technical documentation DocBook customization layer
     Tested with (and requires):
       ...
       DocBook 5 (1.72) from docbook.sourceforge.net
       Apache FOP 0.93
     Customization layer uses:
       FOP1 extensions for PDF bookmarks in Apache FOP 0.93 (xmlns:fox)
  ...
  <xsl:if test="$suppress.navigation = '0' and $suppress.header.navigation = '0'">
    <div class="navheader">
      <xsl:if test="$row1 or $row2">
        <table width="100%" summary="Navigation header" class="navtable">
          <xsl:if test="$row1">
            <tr>
...
<xsl:template name="footer.navigation">
  ...
  <xsl:if test="$suppress.navigation = '0' and $suppress.footer.navigation = '0'">
    <div class="navfooter">
      ...
      <xsl:if test="$row1 or $row2">
        <table width="100%" summary="Navigation footer" class="navtable">
          <xsl:if test="$row1">
            <tr>
